...
public class UsersController : BaseController
{
    ...
    public async Task<IActionResult> ListUsers([FromQuery] ListUsersRequest request, CancellationToken cancellationToken)
    {
        ...
        var paginetedList = new PaginatedList<ListUsersResponse>(data.Item1.ToList(), data.Item2, request.Page, request.Size);

        return OkPaginatedCustomResponse(paginetedList, "Users retrieved successfully");
    }
    ...
    public async Task<IActionResult> GetUser([FromRoute] Guid id, CancellationToken cancellationToken)
    {
        ...
        return OkCustomResponse(data, "User retrieved successfully");
    }
    ...
    public async Task<IActionResult> UpdateUser([FromRoute] Guid id, [FromBody] UpdateUserRequest request, CancellationToken cancellationToken)
    {
        ...
        return OkCustomResponse(data, "User updated successfully");
    }
}
